...
public interface OptionService {
    ...
    default Option dtoToEntity(OptionDTO dto){
        Option entity = Option.builder().option_num(dto.getOptionNum()).bed(dto.isBed()).airConditioner(dto.isAirConditioner())
    ...
    default OptionDTO entityToDto(Option entity){
        OptionDTO dto = OptionDTO.builder().optionNum(entity.getOption_num()).bed(entity.isBed()).airConditioner(entity.isAirConditioner())
